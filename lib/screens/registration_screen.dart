      ...
      body: ModalProgressHUD(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              /* Hero Widget is made flexible here as when the user tries to type in the TextField ,keyboard
              * shows up and overflow problem comes into picture.To avoid this issue ,
              * Hero widget is wrapped with Flexible Widget .*/
              Flexible(
                child: Hero(
                  tag: 'logo',
                  child: Container(
